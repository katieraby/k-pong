...
-- dt = delta time, the amount of time in s since the last frame
 function love.update(dt)
   if love.keyboard.isDown('w') and player1.y >= 10 then
 ...
 function love.draw()
   ...
   if gameState == 'title' then
      ...
      love.graphics.printf('K-Pong', 0, 10, VIRTUAL_WIDTH, 'center')
   ...
   love.graphics.setColor(255/255, 182/255, 211/255)
   love.graphics.setFont(LARGE_FONT)
